...
const CONTENT = {
  ...
  // ---------- Updates ----------
  // Things that happen along the way but weren't part of the original
  // plan — new team members, published articles, conference talks, etc.
  // Each one is pinned to a phase below using "relatedPhase", which must
  // match that phase's "code" exactly (WP1, WP2, WP3... see the phases
  // list further down). It'll appear next to that phase, and scroll with it.
  // A phase can have zero, one, or several updates linked to it.
  // "subtitle" is optional (a date, venue, etc.) — leave it out entirely
  // (delete the whole line) if you don't need one.
  updates: [
    {
